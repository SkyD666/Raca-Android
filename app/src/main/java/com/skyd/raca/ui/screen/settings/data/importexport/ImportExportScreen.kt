...
fun ImportExportScreen() {
    ...
    Scaffold(
        ...
        SettingsLazyColumn(
            ...
            group(category = { CategorySettingsItem(text = stringResource(R.string.import_export_screen_using_file_category)) }) {
                item {
                    BaseSettingsItem(
            ...
            group(category = { CategorySettingsItem(text = stringResource(R.string.import_export_screen_using_cloud_category)) }) {
                item {
                    BaseSettingsItem(
